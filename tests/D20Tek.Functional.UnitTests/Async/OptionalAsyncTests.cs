...
public class OptionalAsyncTests
{
    ...
    public async Task TaskDefaultWithAsync_WithSomeValue_ReturnsValue()
    {
        // arrange
        var x = 10;
        var option = Task.FromResult(Optional<int>.Some(x));
    ...
    public async Task TaskDefaultWithAsync_WithNone_ReturnsDefault()
    {
        // arrange
        var defDate = DateTimeOffset.Now;
        var option = Task.FromResult(Optional<DateTimeOffset>.None());
    ...
    {
        // arrange
        var option = Task.FromResult(Optional<int>.Some(4));
    ...
    {
        // arrange
        var option = Task.FromResult(Optional<int>.Some(1));
    ...
    public async Task TaskIterAsync_WithSomeValue_PerformsAction()
    {
        // arrange
        var output = string.Empty;
        var option = Task.FromResult(Optional<string>.Some("Hello World"));
    ...
    {
        // arrange
        var option = Task.FromResult(Optional<decimal>.Some(100M));
        var ifNone = Optional<decimal>.Some(41);
    ...
    {
        // arrange
        var option = Task.FromResult(Optional<decimal>.None());
        var ifNone = Optional<decimal>.Some(41);
