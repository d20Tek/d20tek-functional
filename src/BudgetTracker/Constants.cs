...
internal static class Constants
{
    ...
    [
        ...
        string.Empty,
        "[yellow]Credits:[/]",
        " - list-cred (lcr): shows list of the user's outstanding credits.",
        " - add-cred (acr): allows user to input new credit item.",
        " - edit-cred (ecr): allows uer to edit basic credit data (name, date, amount).",
        " - delete-cred (dcr): allows user to delete an existing credit item.",
        string.Empty,
