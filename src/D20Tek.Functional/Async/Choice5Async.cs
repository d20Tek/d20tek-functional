...
/// <summary>
/// An async-aware discriminated union of five types with async Match, Bind, Map, and Iter operations.
/// </summary>
    ...
    where T5 : notnull
{
    ...
    /// <summary>Creates a ChoiceAsync holding a value of the fifth type.</summary>
    ...
    /// <summary>Gets whether the stored value is of the fifth type.</summary>
    ...
    /// <summary>Extracts the value as the fifth type.</summary>
