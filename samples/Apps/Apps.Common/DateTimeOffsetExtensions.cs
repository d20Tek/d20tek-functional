...
internal static class DateTimeOffsetExtensions
{
    ...
    public static DateTimeOffset StartOfMonth(this DateTimeOffset d) => new(d.Year, d.Month, 1, 0, 0, 0, d.Offset);

    public static DateTimeOffset StartOfYear(this DateTimeOffset d) => new(d.Year, 1, 1, 0, 0, 0, d.Offset);
